...
echo "debug1 BTC_INITIALIZED: ${BTC_INITIALIZED}"
...
echo "debug2 BTC_INITIALIZED: ${BTC_INITIALIZED}"
...
if [ "${BTC_INITIALIZED}" = "false" ]; then

  echo "Write bitcoin config files."
